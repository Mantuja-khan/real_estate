...
const Navbar = () => {
  ...
  return (
    ...
    <div className="relative bg-white border-b border-gray-100">
      ...
      <div className="md:hidden bg-gray-50 border-b border-gray-100 py-1.5 px-4 flex flex-col items-center gap-1 text-[9px] font-normal text-black">
        <div className="flex justify-between w-full items-center">
          <a href="tel:9818513700" className="flex items-center gap-1 hover:text-[#2c6e3b]">
            <Phone className="h-2.5 w-2.5" /> 98185-13700
          </a>
          <span className="uppercase tracking-tighter">RERA: RERA-PKL-1587-2024</span>
        </div>
        <a href="mailto:support@haryanadeendayalplot.org.in" className="flex items-center gap-1 hover:text-[#2c6e3b] text-[10px]">
          <Mail className="h-2.5 w-2.5" /> support@haryanadeendayalplot.org.in
        </a>
      </div>
      ...
      <div className="container py-2 md:py-4 flex items-center justify-between w-full">
        ...
        <div className="hidden lg:flex items-center gap-6 text-[10px] md:text-xs text-gray-500 font-bold uppercase tracking-wider">
          <Link to="/about-ddjay" className="hover:text-black transition-colors">About</Link>
          ...
          <Link to="/refund-policy" className="hover:text-black transition-colors">Refunds and Cancellation</Link>
        </div>
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-white z-50 border-t border-gray-100 shadow-2xl animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col gap-3">
              <Link to="/about-ddjay" onClick={toggleMenu} className="w-full text-center py-4 rounded-md font-bold text-gray-700 uppercase tracking-widest bg-gray-50 border border-gray-100 shadow-sm text-xs transition-all active:scale-95 hover:bg-green-50 hover:text-[#2c6e3b]">About DDJAY</Link>
              <Link to="/terms" onClick={toggleMenu} className="w-full text-center py-4 rounded-md font-bold text-gray-700 uppercase tracking-widest bg-gray-50 border border-gray-100 shadow-sm text-xs transition-all active:scale-95 hover:bg-green-50 hover:text-[#2c6e3b]">Terms & Conditions</Link>
              <Link to="/contact" onClick={toggleMenu} className="w-full text-center py-4 rounded-md font-bold text-gray-700 uppercase tracking-widest bg-gray-50 border border-gray-100 shadow-sm text-xs transition-all active:scale-95 hover:bg-green-50 hover:text-[#2c6e3b]">Contact Us</Link>
              <Link to="/refund-policy" onClick={toggleMenu} className="w-full text-center py-4 rounded-md font-bold text-gray-700 uppercase tracking-widest bg-gray-50 border border-gray-100 shadow-sm text-xs transition-all active:scale-95 hover:bg-green-50 hover:text-[#2c6e3b]">Refunds & Cancellation</Link>
            </div>
          </div>
        </div>
      )}
      ...
      {isExpired ? (
        ...
        <>
          ...
          <div className="bg-red-600 text-white w-full py-1.5 flex items-center justify-center text-xs font-bold border-b border-white">
