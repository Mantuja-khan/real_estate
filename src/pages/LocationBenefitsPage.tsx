  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="bg-gray-50 p-6 md:p-8 rounded-xl border border-gray-200 shadow-sm max-w-3xl mx-auto mb-10">
          <ul className="list-disc pl-6 space-y-3 text-gray-800 font-medium text-xs sm:text-sm">
            <li className="list-none -ml-6 pb-1">
              <span className="font-bold text-[#2c6e3b] text-base sm:text-lg uppercase tracking-wider">Infrastructure</span>
            </li>
            ...
            <li className="list-none pt-4 -ml-6 pb-1">
              <span className="font-bold text-[#2c6e3b] text-base sm:text-lg uppercase tracking-wider">Education and health care</span>
            </li>
            ...
            <li className="list-none pt-4 -ml-6 pb-1">
              <span className="font-bold text-[#2c6e3b] text-base sm:text-lg uppercase tracking-wider">Entertainment</span>
            </li>
